      ...
      {action === "new" && (
        <div>
          <form>
            ...
            <textarea placeholder="Provide Description here" />
            ...
            <textarea placeholder="Provide Extra info here" />
            ...
            <div className="grid gap-2 sm:grid-cols-3">
              <div>
                ...
                <input type="text" placeholder="16:30" />
              </div>
              <div>
                <h3 className="mt-2 -mb-1">Check out time</h3>
                <input type="text" placeholder="17:30" />
              </div>
              <div>
